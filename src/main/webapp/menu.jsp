...
<body>
	<section class="nav-section">
        ...
        <div class="menu-container" >
            ...
            %>
                <div class="menu-item card" style="height: 400px;">
                    <img class="card-img-top card-img" src="images/menu/menu<%= item.getMenuId() %>.jpg" alt="images" style="height: 35%; width:100%">
                    <div class="card-body">
