	...
	<section class="carousel-section">
	    <div class="d-flex justify-content-between mx-5">
	        <div class="animate__animated animate__fadeInRight text-center">
	            <img alt="Biriyani" src="images/carousel/biriyani.png" class="img-fluid carousel-img">
	            <h4 class="mt-2">Biriyani</h4>
	        </div>
	        <div class="animate__animated animate__fadeInRight text-center">
	            <img alt="Chilli" src="images/carousel/item3.png" class="img-fluid carousel-img">
	            <h4 class="mt-2">Chilli</h4>
	        </div>
	        <div class="animate__animated animate__fadeInRight text-center">
	            <img alt="Pizza" src="images/carousel/pizza.png" class="img-fluid carousel-img">
	            <h4 class="mt-2">Pizza</h4>
	        </div>
	        <div class="animate__animated animate__fadeInRight text-center">
	            <img alt="Noodles" src="images/carousel/noodles.png" class="img-fluid carousel-img">
	            <h4 class="mt-2">Noodles</h4>
	        </div>
	        <div class="animate__animated animate__fadeInRight text-center">
	            <img alt="Meals" src="images/carousel/rice.png" class="img-fluid carousel-img">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                    <div class="card restaurant-card">
                        <a href="menu?restaurantId=<%= restaurant.getRestaurantId() %>" class="card-link">
                            <img src="images/rest/rest<%= restaurant.getRestaurantId() %>.jpg" 
                                 alt="Image of <%= restaurant.getRestaurantName() %>" class="card-img-top" style="height: 200px;">
                            <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="user.jsp" class="text-dark">User</a></li>
                        <li><a href="restaurant.jsp" class="text-dark">Restaurants</a></li>
                        <li><a href="menu.jsp" class="text-dark">Menu</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5>Contact Us</h5>
